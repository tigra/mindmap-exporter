...
class MindmapController {
  ...
  /**
   * Apply layout to the model using the StyleManager
   */
  applyLayout() {
    ...
    // Apply direction override if needed based on current layout type setting
    ...
    if (layoutType === 'horizontal-left') {
      ...
      // Clear any direction override if not explicitly set
